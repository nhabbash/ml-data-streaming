...
class ResNet18(pl.LightningModule):
    def __init__(self, num_classes, learning_rate=1e-3, fine_tune=False):
        ...
        conv1_out_channels = self.feature_extractor.conv1.out_channels
        self.feature_extractor.conv1 = nn.Conv2d(in_channels=1, out_channels=conv1_out_channels, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=True)
